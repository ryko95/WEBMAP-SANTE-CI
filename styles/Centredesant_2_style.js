...
function categories_Centredesant_2(feature, value, size, resolution, labelText,
    ...
    switch (valueStr) {
        ...
        case 'Centre Social':
            return centreIconStyle(feature, resolution, labelText, labelFont, labelFill, bufferColor, bufferWidth, placement, textAlign, offsetX, offsetY, overflow, repeat, 'styles/centre_social.svg', [64,64], 0.43, [32,32], 1);
